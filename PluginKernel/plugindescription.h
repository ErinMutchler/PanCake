...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_00B3BCCDA273432FB6B8196EB5465E9B
#define AU_COCOA_VIEW_NAME AUCocoaView_00B3BCCDA273432FB6B8196EB5465E9B
...
const char* kAAXBundleID = "rackafxuser.aax.PanCake.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.PanCake.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.PanCake.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "PanCake";     // 31 chars max for AAX
const char* kShortPluginName = "PanCake";    // 15 chars max for AAX
const char* kAUBundleName = "PanCake";
...
const char* kVSTFUID = "{00B3BCCD-A273-432F-B6B8-196EB5465E9B}"; /// NOTE: you need the enclosing { }
